...
- Get your [Necessary Variables](https://github.com/CAILIN-MUSIC-USM5/CaiLinXMusic/blob/master/sample.env)
---
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/CAILIN-MUSIC-USM5/CaiLinXMusic && cd CaiLinXMusic
   ```
